 ...
 * @author rosme
 */
public class GUI_NuevoDoctor extends javax.swing.JFrame {
    ...
    String matriz[][]=new String[ctrl.lab_lote_ips_nuevo().size()][1];
        for (int i = 0; i < ctrl.lab_lote_ips_nuevo().size(); i++) {
            matriz[i][0]=ctrl.lab_lote_ips_nuevo().get(i).getLaboratorio();
        }
        laboratorios.setModel(new javax.swing.table.DefaultTableModel(matriz, new String[]{""}));
    }
    
    public void vacunador() throws SQLException{
    String matriz[][]=new String[ctrl.vacunador_nuevo().size()][1];
        for (int i = 0; i <ctrl.vacunador_nuevo().size(); i++) {
            matriz[i][0]=ctrl.vacunador_nuevo().get(i).getPrimer_nombre()+" "+ctrl.vacunador_nuevo().get(i).getPrimer_apellido();
        }
    ...
    String matriz[][]=new String[ctrl.lab_lote_ips_nuevo().size()][1];
        for (int i = 0; i < ctrl.lab_lote_ips_nuevo().size(); i++) {
            matriz[i][0]=ctrl.lab_lote_ips_nuevo().get(i).getNum_lote();
        }
    ...
    String matriz[][]=new String[ctrl.lab_lote_ips_nuevo().size()][1];
        for (int i = 0; i < ctrl.lab_lote_ips_nuevo().size(); i++) {
            matriz[i][0]=ctrl.lab_lote_ips_nuevo().get(i).getIps();
        }
    ...
    String matriz[][]=new String[ctrl.fechas_nuevo().size()][1];
        for (int i = 0; i < ctrl.fechas_nuevo().size(); i++) {
            matriz[i][0]=ctrl.fechas_nuevo().get(i).getFecha_aplicacion();
        }
    ...
    String matriz[][]=new String[ctrl.fechas_nuevo().size()][1];
        for (int i = 0; i < ctrl.fechas_nuevo().size(); i++) {
            matriz[i][0]=ctrl.fechas_nuevo().get(i).getFecha_proxima();
        }
    ...
    public void cargaredades() throws SQLException {
        String matriz[][] = new String[ctrl.edadesNuevo().size()][1];
        for (int i = 0; i < ctrl.edadesNuevo().size(); i++) {
            matriz[i][0] = ctrl.edadesNuevo().get(i).getEdad();
        }
    ...
    public void cargarvacunas() throws SQLException {
        String matriz[][] = new String[ctrl.vacunasNuevo().size()][1];
        for (int i = 0; i < ctrl.vacunasNuevo().size(); i++) {
            matriz[i][0] = ctrl.vacunasNuevo().get(i).getNombre();
        }
    ...
    public void cargardosis() throws SQLException {
        String matriz[][] = new String[ctrl.dosisNuevo().size()][1];
        for (int i = 0; i < ctrl.dosisNuevo().size(); i++) {
            matriz[i][0] = ctrl.dosisNuevo().get(i).getDosis();
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 0, 20, 490));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondooo.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1210, 0, 180, 50));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondooo.jpg"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 590, 50));

        jLabel10.setBackground(new java.awt.Color(0, 0, 0));
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondooo.jpg"))); // NOI18N
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 0, 620, 50));
    ...
    private void btnVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverActionPerformed
       GUI_MenuDoctor h=new GUI_MenuDoctor();
        h.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_NuevoDoctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_NuevoDoctor().setVisible(true);
            }
        });
    }
